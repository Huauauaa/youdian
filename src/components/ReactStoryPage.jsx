...
export default function ReactStoryPage({ base = "/" }) {
	...
	return (
		<main className="mx-auto box-border w-full max-w-[62rem] px-5 pt-7 pb-16">
			<nav
				className="mb-10 flex flex-wrap items-center justify-between gap-4 rounded-full border border-youdian-ink/10 bg-white/55 px-4 py-3 shadow-[0_0.75rem_2rem_rgba(23,32,51,0.05)] backdrop-blur"
				aria-label="React + TailwindCSS 页面导航"
			>
				<a
					className="font-bold text-youdian-accent no-underline transition hover:text-youdian-rust focus-visible:text-youdian-rust"
					href={base}
				>
					← 返回首页
				</a>
				<span className="rounded-full bg-orange-50 px-3 py-1 text-sm font-bold text-youdian-rust">
					React + TailwindCSS
				</span>
			</nav>

			<section className="grid items-center gap-8 rounded-[2rem] border border-youdian-ink/10 bg-white/70 p-[clamp(1.4rem,5vw,3.5rem)] shadow-[0_1.5rem_4rem_rgba(23,32,51,0.08)] md:grid-cols-[1.1fr_0.9fr]">
				<div>
					...
					<p className="inline-flex rounded-full border border-youdian-accent/15 bg-orange-50 px-4 py-2 text-sm font-bold text-youdian-rust">
						{summary}
					</p>
				</div>
							...
							<button
								...
								className={`rounded-2xl border p-4 text-left transition hover:-translate-y-0.5 focus-visible:-translate-y-0.5 ${
									isActive
										...
										: "border-youdian-ink/10 bg-white/70 hover:border-youdian-accent/50 focus-visible:border-youdian-accent/50"
								}`}
			...
			<section
				...
				aria-live="polite"
			>
				<div className="rounded-[1.5rem] border border-youdian-ink/10 bg-white/65 p-6 shadow-[0_1rem_2.5rem_rgba(23,32,51,0.06)]">
				...
				<div className="rounded-[1.5rem] border border-youdian-accent/20 bg-orange-50/90 p-6 shadow-[0_1rem_2.5rem_rgba(180,83,9,0.08)]">
					<p className="mb-2 text-sm font-bold uppercase tracking-[0.16em] text-youdian-accent">
						当前时刻
					</p>
			...
			<section
				className="mt-8 rounded-[1.5rem] border border-youdian-ink/10 bg-white/65 p-6 shadow-[0_1rem_2.5rem_rgba(23,32,51,0.06)]"
							...
							<button
								...
								className={`rounded-2xl border p-4 text-left transition hover:-translate-y-0.5 focus-visible:-translate-y-0.5 ${
									isActive
										...
										: "border-youdian-ink/10 bg-white/70 text-youdian-ink hover:border-youdian-accent/50 focus-visible:border-youdian-accent/50"
								}`}
